...
THREE.PerspectiveCamera.prototype.useDeviceOrientationControls = function(view)
{
    if (this.controls)
    {
        this.controls.enabled = false;
    ...
    if (!this.doControls)
    {
        this.doControls = new THREE.DeviceOrientationControls(this, true);
    }
    this.controls = this.doControls;
