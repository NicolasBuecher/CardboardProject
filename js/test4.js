...
function init(device)
{
    ...
    camera = new THREE.PerspectiveCamera(45, screen.width / screen.height, 0.1, 10000);   // Caméra en vue perspective, FOV de 45 degrés, ratio w/h, intervalle de profondeur [0.1, 10000]
